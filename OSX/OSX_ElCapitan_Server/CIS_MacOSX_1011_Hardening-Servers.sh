#!/bin/bash
#
#CIS MacOSX 10.11 hardening script
#v1.1.0 - 04-02-2015
#author rnolette
#date 06/06/2016
#version 1.0
...
# echo "Please enter the password for the macadmin user: "
# read macadminpassword
######################################################################
...
###############################
# echo "2.2 Date & Time"
systemsetup -f -setnetworktimeserver NTP.domain.local
...
# <key>Password</key>
# <string>$macadminpassword</string>
# </dict>
# </plist>
# EOM
...
#secops 1.3 - modify hosts.deny
touch /etc/hosts.deny
echo "ALL: ALL" >> /etc/hosts.deny
/bin/chmod 644 /etc/hosts.deny
#secops 1.4 - configure ssh
